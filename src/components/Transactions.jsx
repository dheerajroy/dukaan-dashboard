export default function Transactions() {
    return (
        <>
            <h3 className="text-[20px] text-[#1A181E] font-[500] leading-[28px]">Transactions | This Month</h3>
            <div className="bg-white p-[12px] pb-[24px] mb-[32px] rounded-[8px] shadow-[0px_2px_6px_0px_rgba(26,24,30,0.04)] mt-[20px]">
                <div className="flex justify-between">
                    <div className="px-[16px] py-[10px] rounded-[4px] border-[1px] border-[#D9D9D9] bg-white">
                        <div className="flex gap-[8px] items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                                <g clip-path="url(#clip0_34872_3685)">
                                ...
                                <defs>
                                    <clipPath id="clip0_34872_3685">
                                        <rect width="14" height="14" fill="white" />
                                    </clipPath>
                                </defs>
                            </svg>
                            <input type="text" placeholder="Search by order ID..." className="w-[194px] h-[20px] text-[14px] leading-[20px] placeholder-[#999]" />
                        </div>
                    </div>
                    <div className="flex gap-[12px]">
                        <div className="px-[12px] py-[6px] flex items-center gap-[6px] rounded-[4px] border-[1px] border-[#D9D9D9] bg-white">
                            <span className="text-[16px] font-[400] leading-[24px] text-[#4D4D4D]">Sort</span>
                ...
                <table className="w-full text-[14px] mt-[12px]">
                    <thead>
                        <tr className="bg-[#F2F2F2] text-[#4D4D4D]">
                            <td>Order ID</td>
                            <td className="flex justify-center items-center gap-[4px]">
                            ...
                            <td className="text-right flex gap-[4px] items-center justify-end">
                    ...
                    <tbody>
                        {Array.from({ length: 19 }, (_, index) => index + 1).map((_, index) => (
                            <tr key={index} className="text-[#1A181E] border-b-[1px] border-[#d9d9d9]">
                ...
                <div className="flex justify-center items-center gap-[24px] mt-[24px]">
                    <div className="p-[6px] pr-[12px] flex items-center gap-[6px] rounded-[4px] border-[1px] border-[#D9D9D9] bg-white">
                        ...
                        <span className="text-[14px] font-[500] leading-[20px] text-[#4D4D4D]">Previous</span>
                    </div>
                    <div className="pag">
                        <button>1</button>
                        <button>...</button>
                        <button className="bg-[#146EB4] !text-white">10</button>
                        <button>11</button>
                        <button>12</button>
                        <button>13</button>
                        <button>14</button>
                    ...
                    <div className="p-[6px] pl-[12px] flex items-center gap-[6px] rounded-[4px] border-[1px] border-[#D9D9D9] bg-white">
                        <span className="text-[14px] font-[500] leading-[20px] text-[#4D4D4D]">Next</span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
