export default function TopBar() {
    return (
        <div className="fixed left-0 top-0 px-[32px] py-[12px] flex justify-between items-center gap-[16px] bg-white border-b-[1px] border-[#d9d9d9] w-[calc(100vw-224px)] ml-[224px]">
            <div className="flex gap-[16px] items-center">
                <h3 className="text-[#1A181E] leading-[22px] text-[15px] font-[400]">Payments</h3>
                <div className="flex gap-[6px] items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                        <g clip-path="url(#clip0_34872_2522)">
                        ...
                        <defs>
                            <clipPath id="clip0_34872_2522">
                                <rect width="14" height="14" fill="white" />
                            </clipPath>
                        </defs>
                    </svg>
                    <h3 className="text-[12px] text-[#4D4D4D] leading-[16px] font-[400]">How it works</h3>
                </div>
            </div>
            <div className="flex items-center px-[16px] py-[9px] gap-[8px] w-[400px] bg-[#F2F2F2] rounded-[6px]">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                    <g clip-path="url(#clip0_34872_2526)">
                    ...
                    <defs>
                        <clipPath id="clip0_34872_2526">
                            <rect width="16" height="16" fill="white" />
                        </clipPath>
                    </defs>
                </svg>
                <input type="text" placeholder="Search features, tutorials, etc." className="bg-transparent placeholder-[#808080] w-full" />
            </div>
            <div className="flex gap-[12px]">
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" x="10" y="10">
                ...
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
                        <g clip-path="url(#clip0_34872_2537)">
                            <circle cx="20" cy="20" r="20" fill="#E6E6E6" />
